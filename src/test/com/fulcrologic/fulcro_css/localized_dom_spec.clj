(ns com.fulcrologic.fulcro-css.localized-dom-spec
  (:require
    ...
    [com.fulcrologic.fulcro-css.components :as comp :refer [defsc]]
...
(defmacro check-kw-processing [name component expected-classes]
  `(let [real-create# com.fulcrologic.fulcro.dom/macro-create-element*]
     (provided ~name
       ~'(com.fulcrologic.fulcro-css.dom/macro-create-element* args) ~'=1x=> (do
                                                                  (assertions
                                                                    "passes the tag name"
                                                                    (~'aget ~'args 0) ~'=> "div"
       ...
       (com.fulcrologic.fulcro-css.dom/render-to-str ((com.fulcrologic.fulcro-css.primitives/factory ~component) {})))))
...
(defn render-component [component]
  (render-to-str ((comp/factory component) {})))
