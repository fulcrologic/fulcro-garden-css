(ns com.fulcrologic.fulcro-css.localized-dom-spec
  (:require
    ...
    [com.fulcrologic.fulcro.dom-server :refer [render-to-str]]
    [com.fulcrologic.fulcro-css.localized-dom-server :as ldom :refer [div p span]]
...
(defmacro check-kw-processing [name component expected-classes]
  `(let [real-create# com.fulcrologic.fulcro.dom/macro-create-element*]
     (provided ~name
       ~'(com.fulcrologic.fulcro.dom/macro-create-element* args) ~'=1x=> (do
                                                                           (assertions
                                                                             "passes the tag name"
                                                                             (~'aget ~'args 0) ~'=> "div"
       ...
       (binding [comp/*app* (app/fulcro-app)]
         (com.fulcrologic.fulcro.dom/render-to-str ((com.fulcrologic.fulcro.components/factory ~component) {}))))))
...
(defn render-component [component]
  (or (render-to-str ((comp/factory component) {})) ""))

(specification "SSR With Extended classes"
  (assertions
    "kw + no props"
    (render-component NoPropsComponent) =fn=> #(str/includes? % "class=\"com_fulcrologic_fulcro-css_localized-dom-spec_NoPropsComponent__a\" id=\"y\"")
    "kw + nil props"
    (render-component NilPropsComponent) =fn=> #(str/includes? % "class=\"com_fulcrologic_fulcro-css_localized-dom-spec_NilPropsComponent__a\" id=\"y\"")
    "kw + empty cljs props"
    (render-component EmptyPropsComponent) =fn=> #(str/includes? % "class=\"com_fulcrologic_fulcro-css_localized-dom-spec_EmptyPropsComponent__a\" id=\"y\"")
    "kw + empty js props"
    (render-component EmptyJSPropsComponent) =fn=> #(str/includes? % " class=\"com_fulcrologic_fulcro-css_localized-dom-spec_EmptyJSPropsComponent__a\" id=\"y\"")
    "kw + cljs props"
    (render-component CLJPropsComponent) =fn=> #(str/includes? % " class=\"com_fulcrologic_fulcro-css_localized-dom-spec_CLJPropsComponent__a x\" id=\"y\"")
    "kw + cljs props + id override"
    (render-component CLJPropsWithIDComponent) =fn=> #(str/includes? % " id=\"y\" class=\"com_fulcrologic_fulcro-css_localized-dom-spec_CLJPropsWithIDComponent__a x\"")
    "kw + js props + id override"
    (render-component JSPropsWithIDComponent) =fn=> #(str/includes? % " id=\"y\" class=\"com_fulcrologic_fulcro-css_localized-dom-spec_JSPropsWithIDComponent__a x\" ")
    "symbolic class name in props"
    (render-component SymbolicClassPropComponent) =fn=> #(str/includes? % " id=\"y\" class=\"com_fulcrologic_fulcro-css_localized-dom-spec_SymbolicClassPropComponent__a x\"")
    "global + localized kw + cljs props"
    (render-component ExtendedCSSComponent) =fn=> #(str/includes? % " class=\"com_fulcrologic_fulcro-css_localized-dom-spec_ExtendedCSSComponent__a b x\" id=\"y\"")
    "just js props"
    ...
    ":classes in props"
    (render-component DynamicClassesComponent) =fn=> #(str/includes? % " id=\"y\" class=\"com_fulcrologic_fulcro-css_localized-dom-spec_DynamicClassesComponent__a b\" ")
    ":classes as symbol in props"
    (render-component DynamicSymClassesComponent) =fn=> #(str/includes? % " id=\"y\" class=\"com_fulcrologic_fulcro-css_localized-dom-spec_DynamicSymClassesComponent__a b\"")
    ":classes in props as symbol"
    (render-component DynamicSymPropsComponent) =fn=> #(str/includes? % " id=\"y\" class=\"com_fulcrologic_fulcro-css_localized-dom-spec_DynamicSymPropsComponent__a b\" ")
    ":classes in props as symbol + kw"
    (render-component DynamicSymPropsWithKWComponent) =fn=> #(str/includes? % " id=\"y\" class=\"com_fulcrologic_fulcro-css_localized-dom-spec_DynamicSymPropsWithKWComponent__z x com_fulcrologic_fulcro-css_localized-dom-spec_DynamicSymPropsWithKWComponent__a b\" ")
    "cljs props as symbol"
    (render-component SymbolicClassPropsComponent) =fn=> #(str/includes? % " class=\"com_fulcrologic_fulcro-css_localized-dom-spec_SymbolicClassPropsComponent__a x\" id=\"y\"")
    "js props as symbol"
    (render-component SymbolicClassJSPropsComponent) =fn=> #(str/includes? % " class=\"com_fulcrologic_fulcro-css_localized-dom-spec_SymbolicClassJSPropsComponent__a x\" id=\"y\"")
    "nil props as symbol"
    (render-component SymbolicClassNilPropsComponent) =fn=> #(str/includes? % " class=\"com_fulcrologic_fulcro-css_localized-dom-spec_SymbolicClassNilPropsComponent__a\" id=\"y\" ")
    "cljs props as expression"
    (render-component ExprClassPropsComponent) =fn=> #(str/includes? % " class=\"com_fulcrologic_fulcro-css_localized-dom-spec_ExprClassPropsComponent__a x\" id=\"y\"")
    "js props as expression"
    (render-component ExprClassJSPropsComponent) =fn=> #(str/includes? % " class=\"com_fulcrologic_fulcro-css_localized-dom-spec_ExprClassJSPropsComponent__a x\" id=\"y\"")
    "nil props as expression"
    (render-component ExprClassNilPropsComponent) =fn=> #(str/includes? % " class=\"com_fulcrologic_fulcro-css_localized-dom-spec_ExprClassNilPropsComponent__a\" id=\"y\" ")))
