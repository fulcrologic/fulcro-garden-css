...
#?(:cljs
   (defn style-element
     ...
     DEPRECATED: Use com.fulcrologic.fulcro-css.css-injection/style-element instead."
     [component]
...
#?(:cljs
   (defn upsert-css
     ...
     DEPRECATED: Use com.fulcrologic.fulcro-css.css-injection/upsert-css instead."
     [id root-component]
     (remove-from-dom id)
